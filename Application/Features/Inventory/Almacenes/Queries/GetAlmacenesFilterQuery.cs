...
public class GetAlmacenesFilterHandler : IQueryHandler<GetAlmacenesFilterQuery, Response<ResponseFilterDTO<AlmacenDTO>>>
{
    ...
    public GetAlmacenesFilterHandler(IMapper mapper, IRepository<Almacen> repository)
    {
        _mapper = mapper;
        _repository = repository;
    }

    public async Task<Response<ResponseFilterDTO<AlmacenDTO>>> Handle(GetAlmacenesFilterQuery request, CancellationToken cancellationToken)
    {
