...
public class GetCategoriaByIdQuery : IQuery<Response<CategoriaDTO>>
{
    public required long Id { get; set; }
}

public class GetCategoriaByIdHandler : IQueryHandler<GetCategoriaByIdQuery, Response<CategoriaDTO>>
{
