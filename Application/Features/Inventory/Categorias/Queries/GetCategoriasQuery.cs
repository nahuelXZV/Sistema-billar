...
public class GetCategoriasQuery : IQuery<Response<List<CategoriaDTO>>>
{
    public FilterDTO? Filter { get; set; }
}

public class GetCategoriasHandler : IQueryHandler<GetCategoriasQuery, Response<List<CategoriaDTO>>>
{
