...
public class GetListaPreciosQuery : IQuery<Response<List<ListaPrecioDTO>>>
{
}

public class GetListaPreciosHandler : IQueryHandler<GetListaPreciosQuery, Response<List<ListaPrecioDTO>>>
{
