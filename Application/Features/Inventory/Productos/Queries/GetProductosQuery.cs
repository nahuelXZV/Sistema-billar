...
public class GetProductosQuery : IQuery<Response<List<ProductoDTO>>>
{
}

public class GetProductosQueryHandler : IQueryHandler<GetProductosQuery, Response<List<ProductoDTO>>>
{
