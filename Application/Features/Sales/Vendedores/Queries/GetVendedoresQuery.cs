...
public class GetVendedoresQuery : IQuery<Response<List<VendedorDTO>>>
{
}

public class GetVendedoresQueryHandler : IQueryHandler<GetVendedoresQuery, Response<List<VendedorDTO>>>
{
