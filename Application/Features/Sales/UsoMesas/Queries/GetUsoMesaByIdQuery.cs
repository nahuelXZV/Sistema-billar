...
public class GetUsoMesaByIdQuery : ICommand<Response<UsoMesaDTO>>
{
    public required long Id { get; set; }
}

public class GetUsoMesaByIdQueryHandler : ICommandHandler<GetUsoMesaByIdQuery, Response<UsoMesaDTO>>
{
