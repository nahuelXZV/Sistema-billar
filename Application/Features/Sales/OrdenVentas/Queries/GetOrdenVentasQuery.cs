...
public class GetOrdenVentasQuery : ICommand<Response<List<OrdenVentaDTO>>>
{
}

public class GetOrdenVentasQueryHandler : ICommandHandler<GetOrdenVentasQuery, Response<List<OrdenVentaDTO>>>
{
